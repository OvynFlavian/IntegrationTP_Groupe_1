...
?>
<?php function viewProfilAdmin(UserManager $um){
    if(getSessionUser()->getDroit()[0]->getLibelle() != "Administrateur")header("profil.form.php");
    $user = $um->getUserById($_POST['id_user']);
    unset($_POST['id_user']);?>
    <div class="form-group">
        <label class="control-label col-sm-2" for="userName">Pseudo:</label>
        <div class="col-sm-10">

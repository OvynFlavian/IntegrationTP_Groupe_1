 ...
 */
public class ConfJoinGroup extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        user.setText("Voulez-vous vraiment rejoindre ce Groupe? \n " + username);

        btnOui.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                acceptJoinGroupe(username);
                Intent intent = new Intent(ConfJoinGroup.this, VoirGroupe.class);
                startActivity(intent);
                Toast.makeText(ConfJoinGroup.this, "Demande envoyée.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnNon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConfJoinGroup.this, AfficherGroupe.class);
                startActivity(intent);
                Toast.makeText(ConfJoinGroup.this, "demande annulée.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void acceptJoinGroupe(String username) {
        try {
            httpclient = new DefaultHttpClient();
            httppost = new HttpPost("http://www.everydayidea.be/scripts_android/acceptJoinGroupe.php");
    ...
    private void addDrawerItems() {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    Intent intent = new Intent(ConfJoinGroup.this, AfficherAmis.class);
                    startActivity(intent);
                }
                if (position == 1) {
                ...
                if (position == 3) {
                    Intent intent = new Intent(ConfJoinGroup.this, ChoixCategorie.class);
                    startActivity(intent);
                }
                if (position == 4) {
                    logoutUser();
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ConfJoinGroup.this, Accueil.class);
        startActivity(intent);
        finish();
    }
